  ...
  return (
    <nav className={`${styles.navigation} bg-base-100`}>
      ...
      <ul className={styles.navList}>
        <li className={styles.navItem}><Link href="/">Chat</Link></li>
        <li className={styles.navItem}><Link href="/">Playground</Link></li>
        <li className={styles.navItem}><Link href="/">Challenges</Link></li>
        <li className={styles.navItem}><Link href="/">Literature</Link></li>
              ...
              >
                <div className="max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 space-y-2 overflow-x-hidden">
                  {themes.map((t) => (
                    <button
                      key={t}
                      className="flex items-center justify-between px-4 py-3 rounded-lg hover:bg-base-300 transition !m-2 w-50"
                      onClick={() => {
                        setTheme(t);
                        setIsOpen(false);
                      }}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="relative h-6 w-6 rounded-md overflow-hidden grid grid-cols-2 grid-rows-2 gap-px" data-theme={t}>
